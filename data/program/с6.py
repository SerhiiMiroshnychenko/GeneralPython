...
file_path = "Contact (res.partner) (7).csv"
...
selected_columns = ['id_number',
                    "id", "name", "property_product_pricelist/id", "property_supplier_payment_term_id/id",
                    "property_payment_term_id/id"
                    ]
df_imp = df[selected_columns]

# Запис у файл imp.csv
df_imp.to_csv('imp3.csv', index=False)
