...
df_product_8 = pd.read_csv('/home/smiroshnychenko/Runex3/data/products/product.template-8.csv')
...
result_df.to_csv('/home/smiroshnychenko/Runex3/data/products/product_8-16-1.csv', index=False)
