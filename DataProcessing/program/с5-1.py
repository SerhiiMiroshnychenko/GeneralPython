...
# Відбір тільки тих рядків, де є значення для 'id_number'
df_imp = df[selected_columns].dropna(subset=['id_number'])

# Запис у файл imp2.csv
df_imp.to_csv('imp2-1.csv', index=False)
